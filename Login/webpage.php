     ...
     -->
      ...
      <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container-fluid">
          <a class="navbar-brand d-flex mx-1 " href="#" style="padding-top: 12px;padding-bottom: 0px;">
          <svg xmlns="http://www.w3.org/2000/svg" width="27" height="26" fill="currentColor" class="bi bi-clipboard2-data" viewBox="0 0 16 16">
          ...
          <div class="collapse navbar-collapse d-flex justify-content-between " id="navbarSupportedContent">
            ...
            <input class="form-control form-control-dark w-100 d-grid gap-2 d-md-block  mx-1" type="text" placeholder="Search" aria-label="Search">
...
<!-- Modal -->
    ...
    <div class="modal-content">
      ...
      <div class="modal-body d-flex justify-content-center alignitems-center container-fluid">
  ...
  <li class="ms-3"><a class="text-primary" href="https://discord.com/" target="_blank">
    <svg xmlns="http://www.w3.org/2000/svg" width="29" height="29" fill="currentColor" class="bi bi-discord" viewBox="0 0 16 16">
      ...
      <div class="modal-footer py-0 my-0">
        ...
        <!-- <button type="button" class="btn btn-primary">Understood</button> -->
                  ...
                  <button type="button"  onclick="myfun()"  class="btn btn-sm btn-outline-success">Export</button>
                </div>
